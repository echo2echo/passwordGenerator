...
On my machine, the script will hang if the length parameter is somewhere over 300.  If you try over that number you'll get a friendly error message. Your mileage may vary.
